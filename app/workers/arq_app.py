...
from app.workers.calibration_jobs import run_calibration_job
...
class WorkerSettings:
    functions = [
        screen_one, run_refdata, train_ltr, run_eval_job,
        backfill_sanctions_embeddings, run_calibration_job,
    ]
    on_startup = startup
